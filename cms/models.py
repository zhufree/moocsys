...
class Discuss(models.Model):
    ...
    course=models.ForeignKey(Course,related_name='course_discuss',blank=True)#主题讨论时与之相关的课程
...
class Question(models.Model):
    ...
    course=models.ForeignKey(Course,related_name='course_question',blank=True)
...
class Reply(models.Model):
    ...
    discuss=models.ForeignKey(Discuss,related_name='discuss_reply',blank=True)
    question=models.ForeignKey(Question,related_name='question_reply',blank=True)
